...
```{r}
glimpse(cherry_blossom_sample)

ggplot(cherry_blossom_sample, aes(age)) + geom_histogram()

ggplot(cherry_blossom_sample, aes(year, age), fill = age) + geom_count()
```

```{r}
ggplot(cherry_blossom_sample, aes(net)) + geom_density(kernel = "gaussian")
ggplot(cherry_blossom_sample, aes(gun)) + geom_density(kernel = "gaussian")
```
...
```{r}
ggplot(running, aes(age)) + geom_histogram()
